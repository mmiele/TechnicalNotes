...
import os
import sys
sys.path.insert(0, os.path.abspath('../code_samples'))
...
htmlhelp_basename = 'python_languagedoc'
...
man_pages = [
    (master_doc, 'python_language', 'python_language Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'python_language', 'python_language Documentation',
     author, 'python_language', 'One line description of project.',
     'Miscellaneous'),
]
