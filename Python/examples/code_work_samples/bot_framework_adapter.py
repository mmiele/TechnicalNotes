...
class BotFrameworkAdapter:
    ...
    async def process_activity(self, req, auth_header: str, logic: str):
        """
    ...
    async def update_activity(self, context: str, activity: str):
        """
    ...
    async def delete_activity(
        self, context: str, reference: str
    ):
        """
    ...
    async def send_activities(
        self, context: str, activities: List[str]
    ) -> List[str]:
        try:
    ...
    async def delete_conversation_member(
        self, context: str, member_id: str
    ) -> None:
        """
    ...
    async def get_activity_members(self, context: str, activity_id: str):
        """
    ...
    async def get_conversation_members(self, context: str):
        """
    ...
    async def get_user_token(
        ...
        connection_name: str,
        magic_code: str = None,
        oauth_app_credentials: str = None,  # pylint: disable=unused-argument
    ) -> str:
    ...
    async def sign_out_user(
        ...
        user_id: str = None,
        oauth_app_credentials: str = None,
    ):
        """
