...
In the Bot Framework, two broad authentication categories exist: **bot authentication** and **user authentication**. Both have an associated **token** to allow access to secured resources.
